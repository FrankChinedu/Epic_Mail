...
function () {
  ...
  _createClass(MessageController, null, [{
    ...
    value: function () {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                _context8.next = 6;
                return _MessageServices.default.viewASentMessage(data);
      ...
      function viewASentMessage(_x13, _x14) {
    ...
    value: function () {
      ...
      function deleteAnInboxMessage(_x15, _x16) {
    ...
    value: function () {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                _context10.next = 5;
                return _MessageServices.default.deleteASentMessage(data);
      ...
      function deleteASentMessage(_x17, _x18) {

...
messageRoute.get('/messages/sent/:id', _Auth.default.verifyToken, _MessageController.default.viewASentMessage);
...
messageRoute.delete('/messages/sent/:id', _Auth.default.verifyToken, _MessageController.default.deleteASentMessage);

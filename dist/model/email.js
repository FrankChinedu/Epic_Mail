...
function () {
  ...
  _createClass(Email, null, [{
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                ...
                return _context5.abrupt("return", {
                  status: 404,
                  error: "User with email ".concat(recieversEmail, " not found")
                });
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee7(userId, field, table, otherField) {
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                dbQuery = this.qry(field, table, otherField);
                _context7.prev = 1;
                _context7.next = 4;
      ...
      function queryToRun(_x5, _x6, _x7, _x8) {
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                return _context8.abrupt("return", this.queryToRun(userId, 'receiverid', 'inboxs', 'senderid'));
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                return _context9.abrupt("return", this.queryToRun(userId, 'senderid', 'sents', 'receiverid'));
    ...
    value: function () {
      ...
      function deleteInboxMessage(_x12) {
    ...
    key: "deleteASentMessage",
    value: function () {
      var _deleteASentMessage = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee12(_ref10) {
        var userId, id, dbQuery, _ref11, rows;

        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                userId = _ref10.userId, id = _ref10.id;
                dbQuery = 'DELETE FROM sents WHERE messageid=$1 AND senderid=$2 returning *';
                _context12.prev = 2;
                _context12.next = 5;
                return (0, _index.query)(dbQuery, [id, userId]);
      ...
      function deleteASentMessage(_x13) {
        return _deleteASentMessage.apply(this, arguments);
      }

      return deleteASentMessage;
    }()
  }, {
    key: "messageExists",
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee13(userId, messageId, table, field) {
      ...
      function messageExists(_x14, _x15, _x16, _x17) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee14(table, field, userId, messageId) {
        var getQuery, _ref13, rows;
      ...
      function getOneMessage(_x18, _x19, _x20, _x21) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee15(userId, messageId, table, field, otherfield) {
      ...
      function readMessage(_x22, _x23, _x24, _x25, _x26) {
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                userId = _ref14.userId, messageId = _ref14.messageId;
                _context16.next = 3;
              ...
              case 3:
                ...
                _context16.next = 7;
                return this.readMessage(userId, messageId, 'inboxs', 'receiverid', 'senderid');
      ...
      function getAnInboxMessage(_x27) {
    ...
    key: "getASentMessage",
    value: function () {
      var _getASentMessage = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return regeneratorRuntime.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                userId = _ref15.userId, messageId = _ref15.messageId;
                _context17.next = 3;
                return this.messageExists(userId, messageId, 'sents', 'senderid');
              ...
              case 3:
                ...
                _context17.next = 7;
                return this.readMessage(userId, messageId, 'sents', 'senderid', 'receiverid');
      ...
      function getASentMessage(_x28) {
        return _getASentMessage.apply(this, arguments);
      }

      return getASentMessage;
    }()
  }]);

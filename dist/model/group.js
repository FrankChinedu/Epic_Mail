  ...
  _createClass(Group, null, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee3(_ref) {
        var name, userId, qry, res, dbQuery, values, _ref2, rows;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                qry = 'SELECT * FROM groups WHERE name=$1 AND ownerid=$2';
                _context3.next = 4;
                return (0, _index.query)(qry, [name, userId]);
              ...
              case 4:
                ...
                return _context3.abrupt("return", {
                  status: 409,
                  message: "You already have a group with name '".concat(res.rows[0].name, "'")
                });
